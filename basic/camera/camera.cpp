...
int main()
{
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)0);  // "pos" in shader
    glEnableVertexAttribArray(0);
    // texture coord attribute
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)(3 * sizeof(float)));  // "tex" in shader
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        // render boxes
        glBindVertexArray(VAO);
        for (unsigned int i = 0; i < 10; i++)  // generate multiple boxes
        {
