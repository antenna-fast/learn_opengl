...
// Vertex Shader: specific vec's location
...
int main(int argc, char** argv)
{
	...
	GLfloat vertices[] = { 
					...
					0.5, -0.5, 0, 0.0, 1.0, 0.0,	// right_down g
					0.5, 0.5, 0, 0, 0, 1.0	// right_up b
	};
	...
	vec = trans * vec;
	std::cout << "cout: " << vec.x << " " << vec.y << " " << vec.z << std::endl;
	...
	{	i++;
		...
		glUniform4f(vertexPosLocation, greenValue-0.5, 0, 0, 0);  // rgba, uodate uniform must after glUseProgram
