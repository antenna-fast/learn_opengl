...
int main()
{
    ...
    // -------------------------------------------------------------------------------------------
    ourShader.use();
	// ourShader.setVec3("ObjectColor", glm::vec3(1.0, 0.5, 0.5));
    ...
    ourShader.setVec3("light.ambient", glm::vec3(0.2));
    ourShader.setVec3("light.diffuse", glm::vec3(0.5));
    ...
    glm::vec3 lightPos(0.2f, 0.4f, 2.0f);
	glm::mat4 lightModel = glm::mat4(1.0);
	lightModel = glm::translate(lightModel, lightPos);  // trans lightModel using lightPos
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 diffuseColor = lightColor * glm::vec3(0.3);
        ...
        // render boxes
        glBindVertexArray(VAO);
        for (unsigned int i = 0; i < 3; i++)  // generate multiple boxes
        {
